...
namespace Share
{
    ...
    public class PS_NewShare : Cmdlet
    {
        ...
        [Parameter(Position = 0, Mandatory = true, ValueFromPipeline = true,
            ...
            HelpMessage = "Nombre del nuevo recurso compartido.")]
        [ValidateNotNullOrEmpty]
        public string Sharename { get; set; }

        [Parameter(Position = 1, Mandatory = true, ValueFromPipeline = true,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Ruta a la carpeta a compartir.")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(Position = 3, Mandatory = true, ValueFromPipeline = true,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Nivel de acceso SMB que se le otorgará al usuario o grupo.")]
        [ValidateSet("FullControl", "Change", "Read")]
        public ShareCommon.AccessType Access { get; set; }

        [Parameter(Position = 4, Mandatory = false, ValueFromPipeline = true,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Nivel de acceso ACE que se le otorgará al usuario o grupo.")]
        ...
        [Parameter(Position = 6, Mandatory = false, ValueFromPipeline = true,
            ValueFromPipelineByPropertyName = true,
            HelpMessage = "Descripción del recurso compartido")]
